...
if (screen.width >= 768) {
    Promise.all([
        loadExternalResource('https://skin.mcstaralliance.com/plugins/mcstaralliance/assets/css/waifu.css?v=0.2.3', 'css'),
        loadExternalResource('https://skin.mcstaralliance.com/plugins/mcstaralliance/assets/js/live2d.min.js?v=0.2.3', 'js'),
    ]).then(() => {
